...
/**
 * AuditoriamanualimportaciondetalleSearch represents the model behind the search form of `frontend\models\Auditoriamanualimportaciondetalle`.
 */
class AuditoriamanualimportaciondetalleSearch extends Auditoriamanualimportaciondetalle
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Auditoriamanualimportaciondetalle::find()->where(['idInterfase' => $idinterfase]);
