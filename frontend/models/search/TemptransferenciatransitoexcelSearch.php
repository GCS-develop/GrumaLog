...
/**
 * TemptransferenciatransitoexcelSearch represents the model behind the search form of `frontend\models\Temptransferenciatransitoexcel`.
 */
class TemptransferenciatransitoexcelSearch extends Temptransferenciatransitoexcel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'idTransferenciaerp', 'cantidadBase', 'item', 'procesado', 'fila', 'unidadesConteoEmpaque'], 'integer'],
            [['centroOperacionDocumento', 'tipoDocumento', 'fechaDocumento', 'bodegaSalidaDocumento', 'bodegaEntradaDocumento', 'centroOperacion', 'tipoDocumentoMovimiento', 'bodegaSalidaMovimiento', 'centroOperacionMovimiento', 'unidadSalida', 'color', 'talla', 'numero', 'notas', 'codigoBarras', 'codigoUnidadEmpaque'], 'safe'],
    ...
    {
        $query = Temptransferenciatransitoexcel::find()
        ...
        $query->andFilterWhere([
            ...
            'fila' => $this->fila,
            'unidadesConteoEmpaque' => $this->unidadesConteoEmpaque,
        ]);
        ...
        $query->andFilterWhere(['like', 'centroOperacionDocumento', $this->centroOperacionDocumento])
            ...
            ->andFilterWhere(['like', 'codigoUnidadEmpaque', $this->codigoUnidadEmpaque]);
