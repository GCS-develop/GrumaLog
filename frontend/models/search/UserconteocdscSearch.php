...
/**
 * UserconteocdscSearch represents the model behind the search form of `frontend\models\Userconteocdsc`.
 */
class UserconteocdscSearch extends Userconteocdsc
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Userconteocdsc::find()->alias('usc');
