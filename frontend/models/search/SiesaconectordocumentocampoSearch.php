...
/**
 * SiesaconectordocumentocampoSearch represents the model behind the search form of `frontend\models\SiesaConectorDocumentoCampo`.
 */
class SiesaconectordocumentocampoSearch extends SiesaConectorDocumentoCampo
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SiesaConectorDocumentoCampo::find();
