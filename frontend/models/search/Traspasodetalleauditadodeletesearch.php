...
/**
 * Traspasodetalleauditadodeletesearch represents the model behind the search form of `frontend\models\Traspasodetalleauditadodelete`.
 */
class Traspasodetalleauditadodeletesearch extends Traspasodetalleauditadodelete
{
    /**
     * {@inheritdoc}
     */
     ...
     */
    public function search($params, $idtraspaso)
    {
        if ($idtraspaso == null) {
            $query = Traspasodetalleauditadodelete::find()->alias('tdd');
        } else {
            $query = Traspasodetalleauditadodelete::find()->where(['tdd.idTraspaso' => $idtraspaso])->alias('tdd');
        }
