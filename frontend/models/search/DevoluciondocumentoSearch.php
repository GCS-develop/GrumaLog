...
/**
 * DevoluciondocumentoSearch represents the model behind the search form of `frontend\models\Devoluciondocumento`.
 */
class DevoluciondocumentoSearch extends Devoluciondocumento
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if ($registrada == null){
            $query = Devoluciondocumento::find();
        }else{
            $query = Devoluciondocumento::find()->where(['registrada' => $registrada]);
        }
