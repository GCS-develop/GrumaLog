...
/**
 * AuditoriamanualdocumentodetalleSearch represents the model behind the search form of `frontend\models\Auditoriamanualdocumentodetalle`.
 */
class AuditoriamanualdocumentodetalleSearch extends Auditoriamanualdocumentodetalle
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if ($iddocumento == null) {
            $query = Auditoriamanualdocumentodetalle::find()->alias('det');
        } else {
            $query = Auditoriamanualdocumentodetalle::find()->alias('det')->where(['idDocumento' => $iddocumento]);
        }
