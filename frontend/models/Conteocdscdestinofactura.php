...
class Conteocdscdestinofactura extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['idCentroOperacionLegaliza'], 'exist', 'skipOnError' => true, 'targetClass' => Centrooperacion::class, 'targetAttribute' => ['idCentroOperacionLegaliza' => 'id']],
        ];
    }
    ...
    public static function generarTraspasoEncabezado (
        ...
        $content .= "ALMACEN ORIGEN: " . $codigoalmacenlegaliza . "<br>";
        $content .= $nombrealmacenlegaliza . "<br>";

        $content .= "ALMACEN DESTINO: " . $destino->centrooperacion->codigo . "<br>";
        $content .= $destino->centrooperacion->nombre . "<br><br>";

        $content .= "FECHA TRASPASO: " . $fechatraspaso . "<br>";
    ...
    public static function generarTraspasoDetalle ($dataProviderDetalle){
    ...
    public static function generarTraspasoPiePagina ($destino){
