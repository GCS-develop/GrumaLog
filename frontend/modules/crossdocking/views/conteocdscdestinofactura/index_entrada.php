...
$this->title = 'Entrada Factura CDSC';
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '{indexalmacen} {entradafactura}',

                'buttons' => [

                    'indexalmacen' => function ($url, $model) {                                  
                        return Html::a('<i class="fa fa-store"></i>', 
                                [   'indexalmacen', 'idconteofactura' => $model->id, 'origen' => 'entrada'], 
                    ...
                    'entradafactura' => function ($url, $model) {                                  
                        return Html::a('<i class="fa fa-check"></i>', 
                                [   'viewentradafactura', 'idconteofactura' => $model->id], 
                                [   'class' => 'btn btn-default',
                                    'title' => 'Entrada de Factura',
                                    'data' => [
                                        'confirm' => 'Esta Seguro de Registrar Entrada de Factura? ( Proveedor:' . $model->nit . '-' . 
