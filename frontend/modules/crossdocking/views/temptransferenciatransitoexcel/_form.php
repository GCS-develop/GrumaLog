...
<div class="temptransferenciatransitoexcel-form">
    ...
    <?= $form->field($model, 'codigoUnidadEmpaque')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'unidadesConteoEmpaque')->textInput() ?>
