...
<div class="pedidodetalle-form">
    ...
    <?php $form = ActiveForm::begin([
            'action' => ['indexdetalledistribucion'],
            'method' => 'get',
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'oc_consecutivo')->textInput([
                        'placeholder' => 'Consecutivo OC'
                    ])->label(false) ?>
                </div>

                <div class="col-lg-3">
                    <?= $form->field($model, 'bodega_codigo')->textInput([
                        'placeholder' => 'Cod. Tienda'
                    ])->label(false) ?>
                </div>

                <div class="col-lg-3">
                    <?= $form->field($model, 'bodega_nombre')->textInput([
			...
			<div class="form-group" align="center">
                ...
                <?= Html::a('Limpiar', ['indexdetalledistribucion'], ['class' => 'btn btn-primary btn-lg btn-create']) ?>
			</div>
