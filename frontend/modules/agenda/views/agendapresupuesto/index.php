    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                //'template' => '{extraerdatapresupuesto} {viewdatapresupuesto} {viewdatainconsistencia} {delete} {importaragendaxls}',
                ...
                'buttons' => [
                    ...
                    'importaragendaxls' => function ($url, $model) {                                
                        $t = Url::to([  'importaragendaxls', 
                                        'id' => $model->id
                                    ]);

                        return Html::button('<i class="fa fa-upload"></i>',[
                                    'value'=> $t,
                                    'title' => 'Importar Archivo Agendamiento',
                                    'class' => 'btn btn-default btn_upload',
                        ]);
                    },
                                ...
                                [   'class' => 'btn btn-default',
                                    ...
                                    'data' => [
                                        'confirm' => 'Esta Seguro de Eliminar este Período? ( ' . $model->periodoAnio . ' - ' . 
                                                                ProcedimientosGenerales::nombreMes ($model->periodoMes) . ' )',
                                        'method' => 'post',
                                    ]
                                ]
                        );
