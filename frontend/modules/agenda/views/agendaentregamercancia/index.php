...
<div class="agendaentregamercancia-index">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 derecha">
                <?= Html::a('Registrar', ['create', 'idagenda' => $modelagenda->id], ['class' => 'btn btn-primary btn-lg btn-create', 'id'=>'modalButtonCreateTest']) ?>
        </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model){
                    if ($model->fechaCita != null){
                        return substr($model->fechaCita,0,10) . ' ' . $model->horaCita;
                    }
                    return '-';
                },
                //'format' => ['date', 'php:Y-m-d'],
            ...
            [
                ...
                'template' => '{update} {updatedatabasic} {cancel}',
                ...
                'buttons' => [
                    ...
                    'updatedatabasic' => function ($url, $model) {                                
                        $t = Url::to([  'updatedatabasic', 
                                        'id' => $model->id
                                    ]);

                        return Html::button('<i class="fa fa-edit"></i>',[
                                    'value'=> $t,
                                    'title' => 'Actualizar Datos Basicos Agenda',
