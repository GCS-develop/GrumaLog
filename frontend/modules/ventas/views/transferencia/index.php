...
/** @var frontend\modules\ventas\models\search\TransferenciaSearch $searchModel */
...
$totalDocumentoError = Transferencia::totalDocumentoError ($idfactura);
...
<div class="transferencia-index">
    ...
    <?php echo $this->render('_search', ['model' => $searchModel, 'idfactura' => $idfactura]); ?>
    ...
    <div class="row">
        <div class="col-lg-12 centrar">
            <?= Html::a('Generar Archivo Transferencia', ['/ventas/transferencia/generararchivo', 'idfactura' => $idfactura], ['class' => 'btn btn-success btn-lg btn-create']) ?>
        </div>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            /*[
                ...
                'urlCreator' => function ($action, Transferencia $model, $key, $index, $column) {
