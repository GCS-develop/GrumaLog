...
$this->title = 'Factura Recibo Mercancía';
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    'programacion' => function ($url, $model) {                                
                        return Html::a('<i class="fa fa-users"></i>',
                                [   '/programacion/programacionentregamercancia/indexfactura', 'idfactura' => $model->id, ], 
                                [
                                    'title' => 'Programación Recibo Mercancía',
                                    'class' => 'btn btn-default btn_programacion',
                                ]
                        );
                    },
