...
$this->params['breadcrumbs'][] = ['label' => 'Programación Recibo Mercancía', 'url' => ['indexprogramacion']];
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'label' => 'Serie',
                'value' => function ($model){
                    return $model->agendaEntregaMercancia->ordenCompra->tipoDocumento->codigo;
                },
                'hAlign' => 'center', // Alineación horizontal al centro
                'vAlign' => 'middle', // Alineación vertical al centro
            ],
            [
                ...
                'value' => function ($model){
                    return $model->agendaEntregaMercancia->ordenCompra->consecutivo;
                },
                'hAlign' => 'center', // Alineación horizontal al centro
                'vAlign' => 'middle', // Alineación vertical al centro
            ...
            [
                ...
                'value' => function ($model){
                    return $model->idUserConteo ? $model->userConteo->user->username : '-';
                },
                'hAlign' => 'left', // Alineación horizontal al centro
                'vAlign' => 'middle', // Alineación vertical al centro
            ],
            ...
            [
                ...
                'format' => ['decimal', 0], // Formato decimal con 0 decimales
                'value' => function ($model){
                    return Conteoentregamercancia::totalCantidadConteo ($model->idProgramacion,$model->item,$model->idUserConteo, $model->idAgendaEntregaMercancia, $model->idFacturaEntregaMercancia);
                },
                'pageSummary' => true,
            ],
                ...
                'buttons' => [
                    ...
                    'end' => function ($url, $model) {                                  
                        return Html::a('<i class="fa fa-window-close"></i>', 
                                ...
                                [   'class' => 'btn btn-default',
                                    ...
                                    'data' => [
                                        'confirm' => 'Esta Seguro de Finalizar Conteo? ( Programación:' . $model->id . 
                    ...
                    'habilitarconteo' => function ($url, $model) {                                  
                        return Html::a('<i class="fa fa-reply"></i>', 
                                [   '/programacion/programacionentregamercancia/habilitarconteoprogramacion', 'idprogramacion' => $model->id], 
                                [   'class' => 'btn btn-default',
                                    'title' => 'Habilitar Conteo',
                                    'data' => [
                                        'confirm' => 'Esta Seguro de Habilitar Este Conteo? ( OC:' . $model->agendaEntregaMercancia->ordenCompra->tipoDocumento->codigo . '-' .
                                                                                       $model->agendaEntregaMercancia->ordenCompra->consecutivo .  ' - Item:' .
                                                                                        $model->item . ' )',
                                        'method' => 'post',
                                    ]
                                ]
