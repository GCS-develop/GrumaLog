...
/** @var frontend\models\search\AuditoriamanualdocumentodetalleSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Detalle';
$this->params['breadcrumbs'][] = ['label' => 'Devolución Documentos', 'url' => ['/auditoriamanual/auditoriamanualdocumento/register']];
$this->params['breadcrumbs'][] = $this->title;

$fecha_actual = date("Y-m-d");
$filename = "Relacion_Auditoria_Manual_" . $fecha_actual;
?>
...
<div class="auditoriamanualdocumentodetalle-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'vAlign' => 'middle', // Alineación vertical al centro
                'format' => ['decimal', 0], // Formato decimal con 0 decimales
                'label' => 'Cant. unidades registradas',
                'filter' => '',
                'value' => function ($model) {
            $equivalencia = 1;
