    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model){
                    return Auditoriamanualdocumentodetalle::find()->where(['idDocumento' => $model->id])->sum('cantidadDevolucion');
                },
            ...
            [
                ...
                'value' => function ($model){
                    return Auditoriamanualdocumentodetalle::find()->where(['idDocumento' => $model->id, 'registrada' => 1])->sum('cantidadRegistrada');
                },
                'hAlign' => 'center', // Alineación horizontal al centro
                'vAlign' => 'middle', // Alineación vertical al centro
                'format' => ['decimal', 0], // Formato decimal con 0 decimales
                ...
                'buttons' => [
                    ...
                    'view' => function ($url, $model) {                                
                        return Html::a('<i class="fa fa-search"></i>',
                                [   '/auditoriamanual/auditoriamanualdocumentodetalle/index', 'iddocumento' => $model->id, ], 
                                [
