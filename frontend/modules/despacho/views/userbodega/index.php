...
/** @var frontend\models\search\UserbodegaSearch $searchModel */
...
<?php
    Modal::begin([                
        'title'=>'<h4>Registro datos básicos Usuario</h4>',
        'id'=>'modaldata',
        'size'=>'modal-lg',
        'options' => [
...
<div class="userbodega-index">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 izquierda">
            <?= Html::a('Ver Todos', ['/despacho/userbodegaasignacion/index'], ['class' => 'btn btn-success btn-lg btn-create']) ?>
        </div>
    </div>
                ...
                'buttons' => [
                    ...
                    'assign' => function ($url, $model) {                                
                        return Html::a('<i class="fa fa-store"></i>', 
                                [   '/despacho/userbodegaasignacion/index', 'iduserbodega' => $model->id], 
                    ...
                    'delete' => function ($url, $model) {                                  
                        return Html::a('<i class="fa fa-trash"></i>', 
                                [   'delete', 'id' => $model->id], 
                                [   'class' => 'btn btn-default',
                                    'title' => 'Eliminar Usuario Almacén',
                                    'data' => [
