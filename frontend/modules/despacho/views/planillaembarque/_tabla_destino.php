...
<style>
    ...
    .detalle-info {
        ...
        /* Tamaño de letra */
        margin-bottom: 20px;
        /* Espacio entre el div y la tabla */
    }

    .detalle-info strong {
        margin-right: 10px;
        /* Espaciado entre la negrita y el texto siguiente */
    }

    .detalle-info span {
        display: inline-block;
        margin-right: 20px;
        /* Espaciado entre los diferentes bloques de información */
    }
    ...
    .encabezado td {
        vertical-align: top;
        /* Alinea el contenido de las celdas superiormente */
        padding-left: 15px;
...
<table class="encabezado" width="100%">
    <tr>
        ...
        <td width="25%">
            ...
            <img src="<?= Url::to('@web/imagenes/hlogo_resized.png', true) ?>" alt="Logo de la Empresa">
