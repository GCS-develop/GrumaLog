...
$this->registerJsFile(Yii::$app->request->baseUrl.'/js/dataUser.js',
...
<div class="empleadologistica-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <?= $form->field($model, 'email', ['options' => ['id' => 'email']]) ?>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <?= $form->field($model, 'retypePassword')->passwordInput(['id' => 'retypepassword']) ?>
        </div>
    </div>
