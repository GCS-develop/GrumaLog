...
/** @var frontend\models\search\UsertraspasoSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Usuarios Traspaso';
$this->params['breadcrumbs'][] = $this->title;
?>

<?php
    Modal::begin([                
        'title'=>'<h4>Registro datos básicos Usuario Traspaso</h4>',
        'id'=>'modaldata',
        'size'=>'modal-lg',
        'options' => [
                ...
                'buttons' => [
                    ...
                    'assign' => function ($url, $model) {                                
                        ...
                        return Html::button('<i class="fa fa-user"></i>',[
                                    'value'=> $t,
                                    'title' => 'Crear Usuario Nuevo Traspaso',
                    ...
                    'user' => function ($url, $model) {                                
                        ...
                        return Html::button('<i class="fa fa-user-plus"></i>',[
                                    'value'=> $t,
                                    'title' => 'Asignar usuario Traspaso',
                                    'class' => 'btn btn-default btn_user',
                        ]);
                    },
                    ...
                    'delete' => function ($url, $model) {                                  
                        return Html::a('<i class="fa fa-trash"></i>', 
                                ...
                                [   'class' => 'btn btn-default',
                                    'title' => 'Eliminar Usuario Traspaso',
                                    'data' => [
