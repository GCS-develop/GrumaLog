...
use frontend\models\search\UserconteocdscSearch;
...
/**
 * UserconteocdscController implements the CRUD actions for Userconteocdsc model.
 */
class UserconteocdscController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Userconteocdsc models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new UserconteocdscSearch();
    ...
    /**
     * Displays a single Userconteocdsc model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new Userconteocdsc model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new Userconteocdsc();
    ...
    /**
     * Updates an existing Userconteocdsc model.
    ...
    /**
     * Deletes an existing Userconteocdsc model.
    ...
    /**
     * Finds the Userconteocdsc model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return Userconteocdsc the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Userconteocdsc::findOne(['id' => $id])) !== null) {
            return $model;
        }
