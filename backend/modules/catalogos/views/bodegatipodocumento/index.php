...
$this->title = 'Bodega tipo documentos';
$this->params['breadcrumbs'][] = $this->title;
?>

<?php
Modal::begin([
    'title' => '<h4>Datos básicos bodega tipo documentos</h4>',
    'id' => 'modaldata',
    'size' => 'modal-lg',
    'options' => [
    ...
    <?= GridView::widget([
        ...
        return $model->idBodega . ' - ' . $model->bodega->nombre;
            ...
            [
                ...
                'value' => function ($model) {
        return $model->idTipoDocumento . ' - ' . $model->tipodocumento->codigo;
    }
            ],
        ...
        return Html::a(
            ...
            [
                ...
                'data' => [
                    'confirm' => 'Esta Seguro de eliminar de este tipo de documento  ' . $model->idTipoDocumento . ' - ' . $model->tipodocumento->codigo
                        . ' para esta bodega ' . $model->idBodega . ' - ' . $model->bodega->nombre,
                    'method' => 'post',
                ]
            ]
        );
