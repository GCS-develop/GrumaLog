 ...
 */
class BodegatipodocumentoController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Bodegatipodocumento models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new BodegatipodocumentoSearch();
    ...
    /**
     * Displays a single Bodegatipodocumento model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new Bodegatipodocumento model.
    ...
    /**
     * Updates an existing Bodegatipodocumento model.
    ...
    /**
     * Deletes an existing Bodegatipodocumento model.
    ...
    /**
     * Finds the Bodegatipodocumento model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return Bodegatipodocumento the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Bodegatipodocumento::findOne(['id' => $id])) !== null) {
            return $model;
        }
